...
- [06 · 配置](./06-configuration.md) — `PI_WEB_DEFAULT_SOURCE`、`PI_WEB_AUTOSTART` 等 env 变量的完整说明
- [19 · 部署](./19-deployment.md) — 生产环境部署、Docker 打包
- [22 · 开发与测试](./22-development-and-testing.md) — dev 模式运行、`NEXT_DIST_DIR` 隔离构建原理
- [23 · 故障排查 FAQ](./23-troubleshooting-faq.md) — 更多启动问题排查
