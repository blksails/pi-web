...
**步骤 3**（DashScope 场景）：文本对话与图像生成分两个 provider 条目，分别配置对应 key 和端点；AIGC 图像走原生 DashScope 协议，详见 [11-aigc-and-vision-tools.md](11-aigc-and-vision-tools.md)。
...
- [06-configuration.md](06-configuration.md) — env 变量完整表，含 `NEXT_DIST_DIR`、`NEXT_PUBLIC_PI_EXTENSION_BASE_URL`
- [07-providers-and-models.md](07-providers-and-models.md) — `models.json` 格式与 DashScope key 详解
- [12-web-ui-extension.md](12-web-ui-extension.md) — webext 配置、layout/slot 用法
- [11-aigc-and-vision-tools.md](11-aigc-and-vision-tools.md) — AIGC 图像工具、`normalizeImage`、DashScope 端点
- [18-cli.md](18-cli.md) — CLI 启动、`--port` 参数
- [22-development-and-testing.md](22-development-and-testing.md) — 测试环境隔离、e2e 构建跑法
