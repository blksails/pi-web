...
See [02 · Core Concepts](./02-core-concepts.md) and [07 · Agent Development](./07-agent-development.md).
...
See [08 · Attachment System](./08-attachment-system.md).
...
See [10 · Web UI Extension](./10-web-ui-extension.md).
...
See [08 · Attachment System](./08-attachment-system.md) and [09 · Extensions & Skills](./09-extensions-and-skills.md).
...
See [03 · Architecture](./03-architecture.md) and [13 · HTTP API Reference](./13-http-api-reference.md).
...
See [07 · Agent Development](./07-agent-development.md) and [04 · Packages](./04-packages.md).
...
See [09 · Extensions & Skills](./09-extensions-and-skills.md) and [02 · Core Concepts](./02-core-concepts.md).
...
See [12 · Config UI](./12-config-ui.md).
...
See [07 · Agent Development](./07-agent-development.md) and [03 · Architecture](./03-architecture.md).
...
See [04 · Packages](./04-packages.md) and [13 · HTTP API Reference](./13-http-api-reference.md).
...
See [07 · Agent Development](./07-agent-development.md) and [02 · Core Concepts](./02-core-concepts.md).
...
See [13 · HTTP API Reference](./13-http-api-reference.md).
...
See [14 · CLI](./14-cli.md) and [15 · Deployment](./15-deployment.md).
...
See [03 · Architecture](./03-architecture.md) and [15 · Deployment](./15-deployment.md).
...
See [09 · Extensions & Skills](./09-extensions-and-skills.md) and [03 · Architecture](./03-architecture.md).
...
| ContributionPoints | [10](./10-web-ui-extension.md) |
| Dual-mode loading | [02](./02-core-concepts.md) |
| extension UI sub-protocol | [09](./09-extensions-and-skills.md), [02](./02-core-concepts.md) |
| formSchema / Form IR | [12](./12-config-ui.md) |
...
| renderer | [10](./10-web-ui-extension.md) |
| resolve projection | [08](./08-attachment-system.md) |
...
| Slots | [10](./10-web-ui-extension.md) |
| SSE frame | [13](./13-http-api-reference.md) |
| standalone | [14](./14-cli.md), [15](./15-deployment.md) |
| sticky routing | [03](./03-architecture.md), [15](./15-deployment.md) |
| Declarative layout | [10](./10-web-ui-extension.md) |
...
- To start developing a custom agent: [07 · Agent Development](./07-agent-development.md).
- To start writing a WebExtension: [10 · Web UI Extension](./10-web-ui-extension.md).
