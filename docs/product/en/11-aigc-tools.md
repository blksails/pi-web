...
> Still hitting "empty model name / channel does not exist" and confirmed it is an iPhone multi-picture photo? See [18 · Troubleshooting FAQ §2.2](./18-troubleshooting-faq.md#22-iphone-multi-image-jpeg-upload-causes-the-gateway-to-report-empty-model-name-or-channel-does-not-exist), which includes a temporary ImageMagick workaround command for manually extracting the main image.
...
- [08 · Attachment System](./08-attachment-system.md) — how tool outputs are persisted and the `att_<id>` reference mechanism
- [09 · Extensions and Skills](./09-extensions-and-skills.md) — how to assemble tools and extensions in an agent
- [05 · Configuration](./05-configuration.md) — environment variable configuration notes
- [06 · Providers and Models](./06-providers-and-models.md) — NewAPI / DashScope provider integration
- [07 · Agent Development](./07-agent-development.md) — `defineAgent` and `customTools` usage
- [18 · Troubleshooting FAQ](./18-troubleshooting-faq.md#2-provider--model-issues) — 401 / "channel does not exist" ([§2.1](./18-troubleshooting-faq.md#21-custom-provider-auth-401)), iPhone multi-picture JPEG errors ([§2.2](./18-troubleshooting-faq.md#22-iphone-multi-image-jpeg-upload-causes-the-gateway-to-report-empty-model-name-or-channel-does-not-exist))
```
