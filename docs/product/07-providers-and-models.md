...
> **没看到自定义模型？** 多半是配置写错位置或必填字段缺失——排查清单见 [23-troubleshooting-faq.md · 2.1 自定义 provider 鉴权 401](./23-troubleshooting-faq.md#21-自定义-provider-鉴权-401)。
...
> 端点与 key 的完整说明见 [11-aigc-and-vision-tools.md](./11-aigc-and-vision-tools.md)；401 现象的排查步骤见 [23-troubleshooting-faq.md · 2.1 自定义 provider 鉴权 401](./23-troubleshooting-faq.md#21-自定义-provider-鉴权-401)。
...
> 任一步出错（401、模型不出现、下拉为空），优先对照 [23-troubleshooting-faq.md · 2. Provider / 模型问题](./23-troubleshooting-faq.md#2-provider--模型问题)。
