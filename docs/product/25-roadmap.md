...
- [05 · 包结构](./05-packages.md) — `@blksails/embed` 预计位置与包依赖图
- [08 · Agent 开发](./08-agent-development.md) — `AgentDefinition` 定义与本地宿主当前用法
- [09 · 附件系统](./09-attachment-system.md) — 已实现的附件两 spec 详解
- [19 · 部署](./19-deployment.md) — 当前单机部署方案与容器化参考
