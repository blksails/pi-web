...
- [x] 4.0 落实键空间合并的前置归一（**必须早于 4.1 接路由**）
...
- [x] 6.1 使设置界面的 provider 与模型下拉改用统一目录
