...
- [ ] 3.2 (P) afterToolCall base64 剥离闸门
...
- [ ] 4. tool 接入范式与示例 tool
- [ ] 4.1 tool 接入上下文(暴露 store 句柄给 tool 作者)
...
- [ ] 5. runner 集成接线
- [ ] 5.1 把闸门与子进程 store 接入 runner 装配
