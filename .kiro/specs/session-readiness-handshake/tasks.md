...
- [x] 1.1 定义会话生命周期状态枚举与 session-status 控制帧,并入控制帧判别联合
...
- [x] 3.1 在 control store 中新增生命周期状态切片 (P)
