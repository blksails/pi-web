/**
 * @blksails/pi-web-protocol — logging/log-entry
 *
 ...
 *
 * Design decisions:
 *  - LOG_SENTINEL is imported from @blksails/pi-web-logger (the single source of truth)
 *    to avoid sentinel string drift between producer and parser.
 *  - LogEntry type is imported type-only from @blksails/pi-web-logger; LogEntrySchema
...
/** Wire-level log severity enum. Mirrors LogLevel from @blksails/pi-web-logger. */
