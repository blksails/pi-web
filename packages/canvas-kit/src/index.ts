...
// 插件捆注册编排(task 1.3,Req 2.1/2.3/2.4/3.1/3.2/3.4):命名空间前缀化 + requires 拓扑校验。
export { defineCanvasLayer, registerPluginBundles } from "./layers-plugin.js";
export type {
  CanvasLayerPlugin,
  CanvasPluginBundle,
  RegisterPluginBundlesOptions,
} from "./layers-plugin.js";
