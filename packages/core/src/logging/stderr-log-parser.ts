/**
 * @blksails/pi-web-server — logging/stderr-log-parser
 *
 * Stateful line-buffered parser for a subprocess stderr stream.
 *
 * Contract (Req 2.5, 4.3):
 *  - Sentinel lines (prefix LOG_SENTINEL from @blksails/pi-web-logger) → parsed as LogEntry
...
import { parseLogLine, LogEntrySchema } from "@blksails/pi-web-protocol";
