/**
 * core 包的测试分档。四档定义与判据**与兼容层包完全同形**,共享件就住在本包
 * `test/setup/` 与 `test/tiering/`(spec: core-package-extraction,任务 2.1)。
 *
...
const fastSentinel = fileURLToPath(new URL("./test/setup/fast-sentinel.ts", import.meta.url));
