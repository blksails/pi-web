 ...
 *
 * 行为：
 *  - 在启动时向 stderr 写多个 sentinel 格式的结构化日志行（模拟 @blksails/pi-web-logger nodeSink）。
 ...
 *
 * sentinel 格式（来自 @blksails/pi-web-logger node-sink.ts）：
 *   "\x02PILOG\x03 " + JSON.stringify(entry) + "\n"
 */
import process from "node:process";

/** 与 @blksails/pi-web-logger nodeSink 相同的前缀。 */
