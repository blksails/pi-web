 ...
 *
 * Textarea 已整体下沉至 `@blksails/pi-web-primitives`,本模块只做**显式清单转发**:
 * 原模块 HEAD 版导出全集(1 值 + 1 类型)逐一对应,深路径 import
 * (`.../src/ui/textarea.js`)与 ui 内部相对路径消费者双兼容。
 *
...
// ── 值导出(1)──────────────────────────────────────────────────────────────
export { Textarea } from "@blksails/pi-web-primitives";

// ── 类型导出(1)────────────────────────────────────────────────────────────
export type { TextareaProps } from "@blksails/pi-web-primitives";
