/**
 * `gallery-stats` — agents/aigc 的声明式 HTTP route（承接自官方范例 aigc-canvas-agent）。
 *
 * 文件目录标准（见 vendor/pi-web/docs/product/07-agent-development.md「声明式路由的文件组织」）：
 ...
 * 对话 UI 无任何可见变化。
 *
 * 外部调用：GET /api/sessions/<sessionId>/agent-routes/gallery-stats
 */
