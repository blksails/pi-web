...
| [agic-video-agent](./agic-video-agent/) | 以 AIGC agent 为模板的视频工作室首版：简报拆镜头，逐镜头生成/暂停/重试/人工介入/预览/导出 | `video-studio` Surface、隔离 iframe Pane、`mediaToolsExtension`（视频/TTS/ffmpeg） | ★★★★ |
