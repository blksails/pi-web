 ...
 * → @blksails/react transport → <PiChat> — runs unchanged, with NO API key and
...
/**
 * Load @blksails/server's store factory dynamically. Spawned with
...
// jiti/register` so this .mjs can import the TS-source @blksails/server.
